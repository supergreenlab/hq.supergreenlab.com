...
<template>
  <ChecklistSection :icon='require("~/assets/img/icon_monitoring.svg")' title='Checklist metric condition' :onMoveUp='onMoveUp' :onMoveDown='onMoveDown' :onClose='onClose'>
    ...
    <div :class='$style.line'>
      <div :class='$style.row'>
        <div :class='$style.field'>
          Minimum value:
          <input :value='condition.min' @input='e => onChange(Object.assign({}, condition, {min: e.target.value == "" ? null : parseFloat(e.target.value)}))' />
        </div>
        <div :class='$style.field'>
          Maximum value:
          <input :value='condition.max' @input='e => onChange(Object.assign({}, condition, {max: e.target.value == "" ? null : parseFloat(e.target.value)}))' />
        </div>
      </div>
    </div>
    <div :class='$style.line'>
