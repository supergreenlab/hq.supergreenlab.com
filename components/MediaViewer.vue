    ...
    <div :id='$style.carousel'>
      <VueSlickCarousel v-bind="settings">
        <div v-for='media in medias' :key='media.id'>
          ...
          <video v-else-if="mediaType(media) === MEDIA_TYPES.TYPE_VIDEO" ref="videoPlayer" :class="$style.video" @click='onClick(media)' :style='{height, "object-fit": size || "cover"}' autoplay loop playsinline muted defaultMuted>
