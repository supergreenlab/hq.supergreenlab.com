    ...
    <div class="plant_header_content">
      ...
      <div class="plant_header_data">
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_plant_type.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_medium.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_dimension.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_germination_date.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_vegging_since.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_blooming_since.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_drying_since.svg')"/>
          <div>
        ...
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_curing_since.svg')"/>
          <div>
            <span class="data_entry_name">
              Curing
            </span>
        ...
        <h3>Toolbox</h3>
        <div class="data_entry">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_seed.svg')"/>
          <div>
        ...
        <div class="data_entry" v-if="plant.boxSettings.products[0]">
          <img class="data_icon" :src="require('~/assets/img/plant/infos/icon_furniture.svg')"/>
          <div>
