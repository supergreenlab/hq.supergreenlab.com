...
<template>
  <section :id='$style.container'>
    ...
    <div v-if='dragging' :id='$style.dragging' :style='{top: `${mouseY - draggingY}px`, left: `${mouseX - draggingX}px`, width: `${width}px`}' @mouseup='mouseUp' @mousemove='mouseMove'>
      <ArchivedPlant :plant='dragging' />
    </div>
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    mouseDown(e, plant) {
      ...
      this.$data.width = plantEl.getBoundingClientRect().width
